...
const TRANSLATIONS = {
  en: {
    ...
    marketDescription:
      "has a modern mobile infrastructure. SMS remains an effective communication channel for businesses.",
    useCases: {
      ecommerce: {
        title: "E-commerce & Retail",
        description:
          "Order confirmations and promotional campaigns for {country}'s retail market",
        examples: [
          "Order confirmations",
      ...
      banking: {
        ...
        description:
          "OTP verification and transaction alerts for {country}'s financial sector",
        examples: [
          "OTP verification",
          "Transaction alerts",
      ...
      business: {
        ...
        description:
          "Customer engagement and notifications for businesses in {country}",
    ...
    regulations: {
      dataProtection: {
        ...
        description:
          "Comply with local data protection regulations when sending SMS to {country}.",
      },
      optOut: {
  ...
  et: {
    ...
    ctaButton: "Alusta",
    ctaNote:
      "Registreerumine sekunditega · Kuumakseid pole · Täielik API juurdepääs",
    ...
    marketDescription:
      "omab kaasaegset mobiilsidevõrku. SMS jääb ettevõtetele tõhusaks suhtluskanaliks.",
    useCases: {
      ecommerce: {
        title: "E-kaubandus ja jaemüük",
        description:
          "Tellimuste kinnitused ja reklaamikampaaniad {country} jaemüügiturul",
        examples: [
      ...
      banking: {
        ...
        description:
          "OTP kinnitused ja tehinguteatised {country} finantssektoris",
    ...
    regulations: {
      dataProtection: {
        title: "Andmekaitse",
        description:
          "Järgige kohalikke andmekaitsenõudeid SMS-ide saatmisel {country}.",
      },
      optOut: {
        title: "Loobumise nõuded",
        description:
          "Austage kasutajate eelistusi ja haldage loobumise nimekirju.",
      },
      content: {
        title: "Sisu juhised",
  ...
  ru: {
    ...
    ctaButton: "Начать",
    ctaNote:
      "Регистрация за секунды · Без ежемесячной платы · Полный доступ к API",
    ...
    marketDescription:
      "имеет современную мобильную инфраструктуру. SMS остается эффективным каналом связи для бизнеса.",
    useCases: {
      ecommerce: {
        title: "Электронная коммерция и розничная торговля",
        description:
          "Подтверждения заказов и рекламные кампании для розничного рынка {country}",
        examples: [
      ...
      banking: {
        ...
        description:
          "OTP-верификация и уведомления о транзакциях для финансового сектора {country}",
        examples: [
          "OTP-верификация",
      ...
      healthcare: {
        ...
        description:
          "Напоминания о приемах в системе здравоохранения {country}",
        examples: [
      ...
      business: {
        title: "Бизнес-услуги",
        description:
          "Взаимодействие с клиентами и уведомления для бизнеса в {country}",
        examples: [
    ...
    regulations: {
      dataProtection: {
        title: "Защита данных",
        description:
          "Соблюдайте местные правила защиты данных при отправке SMS в {country}.",
      },
      optOut: {
        title: "Требования отказа",
        description:
          "Уважайте предпочтения пользователей и ведите списки отказа.",
      },
      content: {
        title: "Рекомендации по содержанию",
        description:
          "Следуйте местным правилам содержания и культурным нормам.",
      },
    },
  },
  es: {
    ...
    ctaButton: "Empezar",
    ctaNote:
      "Regístrate en segundos · Sin cuotas mensuales · Acceso completo a la API",
    ...
    marketDescription:
      "cuenta con una moderna infraestructura móvil. Los SMS siguen siendo un canal de comunicación efectivo para las empresas.",
    useCases: {
      ecommerce: {
        title: "Comercio Electrónico y Retail",
        description:
          "Confirmaciones de pedidos y campañas promocionales para el mercado minorista de {country}",
        examples: [
      ...
      banking: {
        ...
        description:
          "Verificación OTP y alertas de transacciones para el sector financiero de {country}",
        examples: [
          "Verificación OTP",
      ...
      healthcare: {
        ...
        description:
          "Recordatorios de citas en el sistema de salud de {country}",
        examples: [
      ...
      business: {
        ...
        description:
          "Interacción con clientes y notificaciones para empresas en {country}",
        examples: [
    ...
    regulations: {
      dataProtection: {
        ...
        description:
          "Cumpla con las regulaciones locales de protección de datos al enviar SMS a {country}.",
      },
      optOut: {
        title: "Requisitos de Exclusión",
        description:
          "Respete las preferencias de los usuarios y mantenga listas de exclusión.",
      },
      content: {
        title: "Directrices de Contenido",
        description:
          "Siga las regulaciones locales de contenido y normas culturales.",
      },
    },
  },
  de: {
    ...
    ctaNote:
      "In Sekunden anmelden · Keine monatlichen Gebühren · Voller API-Zugriff",
    ...
    marketDescription:
      "verfügt über eine moderne mobile Infrastruktur. SMS bleibt ein effektiver Kommunikationskanal für Unternehmen.",
    useCases: {
      ecommerce: {
        title: "E-Commerce & Einzelhandel",
        description:
          "Auftragsbestätigungen und Werbekampagnen für den Einzelhandelsmarkt in {country}",
        examples: [
      ...
      banking: {
        title: "Banking & FinTech",
        description:
          "OTP-Verifizierung und Transaktionswarnungen für den Finanzsektor in {country}",
        examples: [
          "OTP-Verifizierung",
      ...
      business: {
        ...
        description:
          "Kundenbindung und Benachrichtigungen für Unternehmen in {country}",
        examples: [
    ...
    regulations: {
      dataProtection: {
        title: "Datenschutz",
        description:
          "Beachten Sie die lokalen Datenschutzbestimmungen beim Versenden von SMS nach {country}.",
      },
      optOut: {
        title: "Opt-out-Anforderungen",
        description:
          "Respektieren Sie die Präferenzen der Benutzer und pflegen Sie Opt-out-Listen.",
      },
      content: {
        title: "Inhaltsrichtlinien",
        description:
          "Befolgen Sie lokale Inhaltsvorschriften und kulturelle Normen.",
      },
    },
  },
  fr: {
    ...
    ctaButton: "Commencer",
    ctaNote:
      "Inscrivez-vous en quelques secondes · Pas de frais mensuels · Accès complet à l'API",
    ...
    marketDescription:
      "dispose d'une infrastructure mobile moderne. Le SMS reste un canal de communication efficace pour les entreprises.",
    useCases: {
      ecommerce: {
        title: "E-commerce et Vente au Détail",
        description:
          "Confirmations de commande et campagnes promotionnelles pour le marché de détail de {country}",
        examples: [
      ...
      banking: {
        ...
        description:
          "Vérification OTP et alertes de transaction pour le secteur financier de {country}",
        examples: [
          "Vérification OTP",
      ...
      healthcare: {
        title: "Santé",
        description:
          "Rappels de rendez-vous dans le système de santé de {country}",
        examples: [
      ...
      business: {
        ...
        description:
          "Engagement client et notifications pour les entreprises en {country}",
        examples: [
          "Rappels de réunion",
    ...
    regulations: {
      dataProtection: {
        ...
        description:
          "Respectez les réglementations locales sur la protection des données lors de l'envoi de SMS vers {country}.",
      },
      optOut: {
        title: "Exigences de Désinscription",
        description:
          "Respectez les préférences des utilisateurs et maintenez des listes de désinscription.",
      },
      content: {
        title: "Directives de Contenu",
        description:
          "Suivez les réglementations locales sur le contenu et les normes culturelles.",
      },
    },
  },
  lv: {
    ...
    ctaButton: "Sākt",
    ctaNote:
      "Reģistrējieties dažu sekunžu laikā · Nav mēneša maksas · Pilna piekļuve API",
    ...
    marketDescription:
      "ir moderna mobilo sakaru infrastruktūra. SMS joprojām ir efektīvs komunikācijas kanāls uzņēmumiem.",
    useCases: {
      ecommerce: {
        title: "E-komercija un Mazumtirdzniecība",
        description:
          "Pasūtījumu apstiprinājumi un reklāmas kampaņas {country} mazumtirdzniecības tirgum",
        examples: [
          "Pasūtījumu apstiprinājumi",
          "Piegādes paziņojumi",
          "Zibatlaižu brīdinājumi",
        ],
      },
      banking: {
        title: "Banku un FinTech",
        description:
          "OTP verificēšana un darījumu brīdinājumi {country} finanšu sektoram",
        examples: [
          "OTP verificēšana",
          "Darījumu brīdinājumi",
          "Drošības paziņojumi",
        ],
      },
      healthcare: {
        ...
        description:
          "Pieraksta atgādinājumi {country} veselības aprūpes sistēmā",
        examples: [
          "Pieraksta atgādinājumi",
          "Testa rezultāti",
          "Veselības padomi",
        ],
      },
    ...
    regulations: {
      dataProtection: {
        ...
        description:
          "Ievērojiet vietējos datu aizsardzības noteikumus, sūtot SMS uz {country}.",
      },
      optOut: {
        title: "Atteikšanās prasības",
        description:
          "Respektējiet lietotāju preferences un uzturiet atteikšanās sarakstus.",
      },
      content: {
        title: "Satura vadlīnijas",
        description:
          "Ievērojiet vietējos satura noteikumus un kultūras normas.",
      },
    },
  },
  lt: {
    ...
    ctaButton: "Pradėti",
    ctaNote:
      "Užsiregistruokite per kelias sekundes · Jokių mėnesinių mokesčių · Pilna prieiga prie API",
    ...
    marketDescription:
      "turi modernią mobiliojo ryšio infrastruktūrą. SMS išlieka veiksmingu verslo komunikacijos kanalu.",
    useCases: {
      ecommerce: {
        title: "El. prekyba ir Mažmeninė prekyba",
        description:
          "Užsakymų patvirtinimai ir reklaminės kampanijos {country} mažmeninės prekybos rinkai",
        examples: [
          "Užsakymų patvirtinimai",
          "Pristatymo pranešimai",
          "Žaibo išpardavimų įspėjimai",
        ],
      },
      banking: {
        title: "Bankininkystė ir FinTech",
        description:
          "OTP patvirtinimas ir sandorių įspėjimai {country} finansų sektoriui",
        examples: [
          "OTP patvirtinimas",
          "Sandorių įspėjimai",
          "Saugumo pranešimai",
      ...
      healthcare: {
        ...
        description:
          "Vizitų priminimai {country} sveikatos priežiūros sistemoje",
        examples: [
          "Vizitų priminimai",
          "Tyrimų rezultatai",
          "Sveikatos patarimai",
    ...
    regulations: {
      dataProtection: {
        ...
        description:
          "Laikykitės vietinių duomenų apsaugos taisyklių siųsdami SMS į {country}.",
      },
      optOut: {
        title: "Atsisakymo reikalavimai",
        description:
          "Gerbkite vartotojų pageidavimus ir tvarkykite atsisakymo sąrašus.",
      },
      content: {
        title: "Turinio gairės",
        description:
          "Laikykitės vietinių turinio taisyklių ir kultūrinių normų.",
      },
    },
  },
};
    ...
    <section class="cta-section relative py-16 lg:py-24 overflow-hidden">
      ...
      <div class="container mx-auto px-8 text-center max-w-[800px]">
        ...
        <div class="cta-actions flex flex-col sm:flex-row justify-center gap-4 mb-6">
          ...
          <a href="https://relio.work/helpdesk/smspmcom" class="btn btn-secondary btn-large light text-white border-white/30 hover:bg-white/10">
            ${t.contactSupport}
          </a>
        </div>
